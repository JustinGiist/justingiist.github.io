...
const EnterpriseTheme = () => {
  ...
  return (
    <>
      ...
      <div className="cardContainer twoCols">
      ...
      <div className="cardContainer ">
        <div className="card Left chart">
          <div className="headline two">Company Performance</div>
          <Chart
            className="chart"
            chartType="Bar"
            width={"100%"}
      ...
      <div className="cardContainer twoCols">
        <div className={"card Down chart"}>
          <div className="headline two">Portfolio Distribution</div>
          <Chart
            chartType="PieChart"
            data={pieChartData}
            options={{
        ...
        <div className="card Left chart">
          <div className="headline two">Monthly Stock Performance</div>
          <Chart
      ...
      <div className="cardContainer ">
        <div className="card Left chart">
          <div className="headline two">Global Company Performance</div>
          <Chart
            options={{
              colors: chartColors,
            }}
