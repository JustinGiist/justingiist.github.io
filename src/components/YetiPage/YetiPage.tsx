        ...
        inputs: [
            {
                ...
                layoutClassName: 'flex noWrap',
                element: [
                    TreesSvg,
                    <div className="flexColumn">
                        <h1>Yeti Walk</h1>
                        <h3>Yeti Walk is an ongoing Global Movement to get explorers connected with the latest and greatest Frozen Travel Destinations</h3>
                    </div>
                ]
            },
            {
                ...
                className: 'card',
                label: 'Yeti Walk',
                subLabel: 'Come visit our great locations',
...
const TreesSvg = (
    <svg id="yeti-trees" viewBox="25.452 10.873 378.394 480" width="235" height="300">
